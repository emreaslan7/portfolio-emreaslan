        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          <div className="flex items-center w-full">
            ...
            <div className="border bg-primary z-10 rounded-xl px-4 py-1">
              <span className="text-background text-sm font-medium">Activities</span>
            </div>
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              I turn technical learning into practical projects across AI/ML,
              Web3, image processing, and full-stack software. Here are a few
              activity highlights from that work.
            </p>
          </div>
        </div>
        <Timeline>
